...
- **Existing patterns detection** — The `critique` and `second-opinion` skills grep for existing utilities/helpers/conventions that the critiqued code might be duplicating, surfacing solved-problem reinvention.
